...
## Pre-release: 2025.12.14b25

- **Change**: Consolidated Thermostatic settings into `omlet_smart_coop.set_fan_mode` and removed the standalone `omlet_smart_coop.set_fan_thermostatic` service (dev environment simplification).
