...
## Pre-release: 2025.12.14b26

- **Change**: Fan settings consolidated under `omlet_smart_coop.set_fan_mode` (manual/time/thermostatic fields). The standalone `omlet_smart_coop.set_fan_thermostatic` service is removed.
