...
## Pre-release: 2025.12.14b24

- **Fix**: `set_fan_thermostatic` now treats `set_mode_thermostatic: null` as “use default = true”, so Thermostatic mode is reliably enabled when you don’t explicitly turn that flag off.
