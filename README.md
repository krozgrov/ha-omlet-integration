...
## Pre-release: 2025.12.14b1

- **Fix**: Smart Coop Fan now supports `fan.turn_on` / `fan.turn_off` correctly in Home Assistant (advertises TURN_ON/TURN_OFF support so HA will allow toggling).
