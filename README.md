...
## Pre-release: 2025.12.14b27

- **Change**: Fan services simplified to a **single** service: `omlet_smart_coop.set_fan_mode` (includes manual/time/thermostatic fields). Removed the standalone fan services (`set_fan_manual_speed`, `set_fan_time_slot`, `clear_fan_time_slot`, `set_fan_time_slot_1`).
